...
namespace WindowsForms.SP
{
    ...
    public partial class SegundoParcial : Form
    {
        ...
        {
            MessageBox.Show("Mazzucchelli Juan");
            this.Text = "Mazzucchelli Juan";
        }
        ...
        {
            bool todoOK = Tiketeadora<Goma>.ImprimirTiket(this.c_gomas );//Reemplazar por la llamada al método de clase ImprimirTicket
        ...
        private void btnPunto6_Click(object sender, EventArgs e)
        {
            ...
            this.cn = new SqlConnection(@"Data Source = localhost\SQLEXPRESS; Initial Catalog = sp_lab_II_utiles; Integrated Security = True");
        ...
        private void btnPunto7_Click(object sender, EventArgs e)
        {
            ...
            foreach(Utiles u in this.c_utiles.Elementos)
            {
                ...
                fila["marca"] = u.marca;
                fila["precio"] = u.precio;
                fila["tipo"] = u.GetType().Name;

                dt.Rows.Add(fila);
            }
            foreach (Lapiz u in this.c_lapices.Elementos)
            {
                DataRow fila = this.dt.NewRow();
                fila["marca"] = u.marca;
                fila["precio"] = u.precio;
            ...
            foreach (Goma u in this.c_gomas.Elementos)
            {
                DataRow fila = this.dt.NewRow();
                fila["marca"] = u.marca;
                fila["precio"] = u.precio;
        ...
        private void btnPunto9_Click(object sender, EventArgs e)
        {
            ...
            DataRow fila = this.dt.Rows[dt.Rows.Count - 1];
        ...
        private bool ConfigurarDataAdapter()
        {
            ...
            try
            {
                ...
                this.da.InsertCommand = new SqlCommand("INSERT utiles (marca, precio, tipo) VALUES (@marca, @precio, @tipo)", cn);
