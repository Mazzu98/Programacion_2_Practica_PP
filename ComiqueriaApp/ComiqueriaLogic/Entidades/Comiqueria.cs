...
namespace ComiqueriaLogic
{
    public class Comiqueria
    {
        ...
        public Comiqueria()
        {
            ...
            productos = ac.ObtenerListado();
            productosListChanged += this.ActualizarProductos;
        ...
        public void Vender(Producto producto, int cantidad)
        {
            ...
            Serializador<Venta>.EscribirBinario(ruta,nuevaVenta);
            ...
            Serializador<Venta>.EsctibirtXml(ruta, nuevaVenta);
